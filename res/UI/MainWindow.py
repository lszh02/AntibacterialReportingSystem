...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.prescription_sheet = QtWidgets.QComboBox(self.page_1)
        self.prescription_sheet.setGeometry(QtCore.QRect(250, 390, 121, 31))
        self.prescription_sheet.setObjectName("presc_sheet")
        self.prescription_sheet.addItem("")
        self.prescription_sheet.addItem("")
        self.prescription_sheet.addItem("")
        self.prescription_sheet.addItem("")
        self.prescription_sheet.addItem("")
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(0, 20, 541, 601))
        ...
        self.ddd_progress_text = QtWidgets.QTextBrowser(self.layoutWidget1)
        self.ddd_progress_text.setObjectName("ddd_progress_text")
        self.horizontalLayout_7.addWidget(self.ddd_progress_text)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.prescription_sheet.setItemText(0, _translate("MainWindow", "Sheet1"))
        self.prescription_sheet.setItemText(1, _translate("MainWindow", "Sheet2"))
        self.prescription_sheet.setItemText(2, _translate("MainWindow", "Sheet3"))
        self.prescription_sheet.setItemText(3, _translate("MainWindow", "Sheet4"))
        self.prescription_sheet.setItemText(4, _translate("MainWindow", "Sheet5"))
